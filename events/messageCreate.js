...
module.exports = new Event('messageCreate', (client, message) => {
	...
	if(!message.member.permissionsIn(message.channel).has(command.permission)) {return message.reply(`You do not have the permission \`${command.permission}\` to run this command!`);}
