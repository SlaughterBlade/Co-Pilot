...
class Client extends Discord.Client {
	...
	async init(token) {
		if (!token) {return console.error('--- ERROR: Bot token is empty! Make sure to fill this out in config.js');}
		...
		if (!config.geniusApiToken) {console.log('No Genius API token provided. Lyrics feature might not work properly.');}
