...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addIntegerOption(option => option.setName('track1').setDescription('The track number you want to swap').setRequired(true))
		.addIntegerOption(option => option.setName('track2').setDescription('The track number you want to swap').setRequired(true)),
