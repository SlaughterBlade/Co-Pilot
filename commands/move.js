...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addIntegerOption(option => option.setName('track').setDescription('The track number you want to move').setRequired(true))
		.addIntegerOption(option => option.setName('position').setDescription('The position to move it to').setRequired(true)),
